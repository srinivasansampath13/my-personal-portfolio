...
const Header: React.FC<HeaderProps> = ({handleLoginOnClick}) => {
  console.log('Header component rendered',handleLoginOnClick)
  return (
                ...
                <div className='flex flex-row gap-3'>
                  ...
                  <div className='w-2/4'>
                        <ol className='flex flex-row justify-around items-center gap-3 h-full'>
                            ...
                            <Button variant="gradient" color='amber' className="flex items-center gap-0.5 rounded-full">
                                <svg className='text-black h-5 w-5' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
                                </svg>
                                <Link href = "#" className='font-lato text-black'>Tech Known</Link>
                            </Button>
                            </li>
                            <li className='text-whitepx-3'>
                  ...
                  <div className='w-1/4 justify-center flex'>
                    <div className='flex items-center'>
                        <Button onClick={() => handleLoginOnClick()} className='rounded-lg bg-gradient-to-tr from-pink-800 to-red-700' color='purple' variant='filled'>Log In</Button>
                    </div>
                  </div>
                </div>
            </main>
